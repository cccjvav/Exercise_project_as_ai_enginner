...
**版本：2026-09-13 · 9 个阶段，22 节小课。** 教材已按完整阶段提前准备；**1A 已完成，1B 进行中：已完成短路/标题题、正文非空对照实操及 Document 职责区分题。** 后续内容并未自动验收。
...
- [1B：短路、空白清理与标题校验（含纠错）](../lessons/01b-structured-loading.md#已完成问答与标准答案)。
