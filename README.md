...
**项目驱动的 AI 工程课程：9 个阶段，28 节小课（22 节教材已备齐；2026-09-23 修订新增 1 节语料课与 5 节集成课，目前为骨架）。**

教学方式：**完整示例 → 逐行讲解 → 预测结果 → 按明确步骤做关键改动 → 闭卷小实现 → 验证与反思**。不要求你先从空文件摸索；理解和验收不以默写代码为标准；每课收尾前有一道 10–20 行的闭卷小实现，学习用文件由你自己提交。
...
- **[全部课程目录](docs/course/index.md)** — 28 节小课、顺序和阶段验收要求；[2026-09-23 课程修订记录](docs/course/course-revision-2026-09-23.md)说明了为什么加课、模型走免费 API、最低毕业线。
...
**当前进度：阶段 1 基础验收通过；学习者已确认进入阶段 2，2A 进行中。** 提前备齐教材，不代表后续阶段已自动通过；完成一阶段后，导师仍会询问是否继续。
...
docs/lessons/        28 节小课（6 节为规划骨架）+ 阶段 1 总览
